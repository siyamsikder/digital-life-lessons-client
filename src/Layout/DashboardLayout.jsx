      ...
      <div className="drawer-side">
        ...
        <aside className="w-64 bg-card text-heading border-r border-base shadow min-h-full flex flex-col">
          ...
          <ul className="menu p-4 gap-1">
            ...
            <li><Link className="text-heading" to="/pricing">Pricing / Upgrade</Link></li>
            <li><Link className="text-heading" to="/payment/success">Payment Success</Link></li>
            <li><Link className="text-heading" to="/payment/cancel">Payment Cancel</Link></li>
